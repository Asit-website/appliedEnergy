                ...
                <div>
                  <img src={smallimg} alt="" />
                        ...
                        <div className="procons2_right">
                            ...
                            <p>
                                Applied Energy MPPT Charge Controller delivers efficient power to both load and battery, <br /> leveraging advanced switch-mode technology and Digital Signal Processing for precise <br /> management. It supports parallel connections and integrates with the Applied Energy Remote <br /> Monitoring Unit for unified, cost-effective network management. Designed for scalability, it is compatible with high-current cells, and next-generation solar technologies like Topcon, HJT, and Perovskite.
