  ...
  return (
    <>
          ...
          <div className="whosec2">
            <div className="pros2coleft">
              <div className="largpro_div">
                <img
                  src="https://res.cloudinary.com/dbcmdtr3r/image/upload/v1742627072/images_2-removebg-preview_hyv9he.png"
                  alt="largeimg"
                  className="largeimg"
                />
              </div>
            ...
            <div className="procons2_right">
              ...
              <p>The Applied Energy Next-Gen RMS is a state-of-the-art hybrid energy management solution
                purpose-built for seamless operation, monitoring, and control of telecom networks and
                datacenters. Designed for modern energy applications, it combines advanced hardware and
                software capabilities to deliver exceptional performance, scalability, and reliability.</p>

              <p>With its robust features and intelligent design, the Next-Gen RMS empowers telecom and
                datacenter operators to optimize energy efficiency, ensure uninterrupted performance, and
                enhance operational reliability for mission-critical systems.
              </p>
              {/* <p>
      ...
      <h4>REF. <span>4231/406</span></h4>
          ...
          <div className="description-content">
            {activeTab === "description" ? (
              <>
                ...
                <p> <b>Next-Gen RMS (Resource Management System)</b> in applied energy includes advanced features such as:

                </p>
                <ul>
                  <li>AI-Driven Energy Optimization – Uses machine learning to optimize resource allocation and reduce energy waste.</li>
                  <li>Real-Time Monitoring & Analytics – Provides real-time data insights for better decision-making.</li>
          ...
          <section>
            <a
              href="/Applied Energy RMS Datasheet.pdf"
              download="Applied_Energy_RMS_Datasheet.pdf"
            >
