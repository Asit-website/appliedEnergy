...
function Product() {
    ...
    return (
            ...
            <section className="products2wa">
              ...
              > */}
                            ...
                            <div className="headding">
                                ...
                                <h3>Rectifier AR48-850</h3>
                            </div>

                            <p>The AST R48-850 rectifier efficiently converts standard AC
                                supply voltages into stable nominal-48V DC voltage,
                                tailored to meet the specific requirements of various
                                applications.</p>

                            <p>
                                Featuring constant power output, this rectifier offers
                                enhanced performance. To accommodate higher load
                                capacities, multiple rectifiers can be connected in parallel,
                                and for added intelligent control, a separate controller can
                                be integrated.
                            </p>
                            {/* <p>
      ...
      <p>Bill Payment for seamless bill in financial  insights.The system also manages Utilities and Masters, monitors Fuel Usage for optimization  Additionally, it tracks AManagement to ensure effective asset utilization, offering a comprehensive solution for cost-effective, data-driven managof energy infrastructure.
                    ...
                    <div className="description-content">
                        {activeTab === "description" && (
                            <>
                                ...
                                <p>
                                    Reduce operational expenses by utilizing high-efficiency rectifiers, achieving an efficiency of 96.5% to meet the specific requirements of various applications.
                                </p>
                                <p>Operate your DC plant effectively in challenging environments thanks to its wide input voltage rang</p>
                                <ul>
                                    <li>
                                        High Efficiency - The rectifier is designed for energy saving, with a high efficiency rating, potentially up to 95.2%.
                                    </li>
                                    <li>
                                        High Reliability - The rectifier is built for long-term, dependable performance.
                                    </li>
                                    <li>
                                        Low Inrush Current - This feature helps prevent power surges during startup, protecting connected equipment.
                                    </li>
                                    <li>
                                        Low Noise Level - The rectifier operates quietly, minimizing potential noise interference.
                                    </li>
                                    <li>
                                        Optimized Power Availability - This suggests the rectifier is designed to provide a stable and consistent power supply, even under varying conditions.
                                    </li>
                                    <li>
                                        Power Factor Correction - This feature improves the efficiency of power usage by minimizing reactive power.
                                    </li>
                                </ul>
                            </>
                        )}
                    ...
                    <section>
                        <a
                            href="/Datasheet_AR48-850W_RM.pdf"
                            download="Datasheet_AR48-850W_RM.pdf"
                        >
