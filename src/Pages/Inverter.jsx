    ...
    useEffect(()=>{
      ...
      <div className="procons2_right">
        <div className="headding">
          ...
          <h3>Inverter AE48-2000</h3>
        </div>
    
        <p>The 2 KVA inverter has been meticulously designed for 
telecom applications. It adeptly converts 48V DC power 
into a 230V AC output, facilitating the operation of ACpowered telecom equipment.</p>
    
    <p>Its design is well-suited for operation in both indoor and 
outdoor environments, adhering to the standard 19” rackmount configuration specified by telecom standards for 
outdoor use.
    </p>

    <p>The inverter is designed with a 19” shelf-mount solution 
    for effective space management.</p>
        {/* <p>
              ...
              <div className="description-content">
                {activeTab === "description" ? (
                  <>
                    ...
                    <p><b>Energy Saving</b> – Utilizes innovative technology to 
                    maximize efficiency.</p>
                    <p><b>Optimal Functionality</b> – Performs effectively across a 
                  ...
                  <>
                   ...
                   <p><span style={{fontWeight: "700", fontSize: "18px"}}>This inverter </span>is designed to effectively 
supply power to telecom loads at both 
indoor and outdoor telecom cell sites, 
Including :-</p>    
                    <ul>
                      <li> Network base stations.</li>
                      <li> Small cell sites.</li>
