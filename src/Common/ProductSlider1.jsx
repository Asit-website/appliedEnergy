      ...
      <div className='whitee'>
        ...
        <Link to="/Rectifier">  <div  >
            ...
            <div className="slidim_wrs sm_ty">
              <img src="https://res.cloudinary.com/dbcmdtr3r/image/upload/v1744228563/images_7-removebg-preview_ema7xf_lpq6yp.png" alt="Slide Image" />
            </div>
         ...
         <NavLink to="/Dcem"> <div >
            <img className="testy" width={40} height={40} src={kij} alt="kij" />
            <div className="slidim_wrs sm_ty">
              <img src="https://res.cloudinary.com/dbcmdtr3r/image/upload/v1744228564/images_1-removebg-preview_olu5wy_zb0ug6.png" alt="Slide Image" />
            </div>
            <div className="slid_titlee">
              <div className='subrr'>
                <h4>DCEM</h4>
